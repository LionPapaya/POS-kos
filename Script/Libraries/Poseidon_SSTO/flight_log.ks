...
// Version 13 adds preflare pitch feed-forward and saturation evidence needed
// to distinguish a late pull-up command from insufficient vehicle authority.
global POS_LOG_SCHEMA_VERSION is 13.
