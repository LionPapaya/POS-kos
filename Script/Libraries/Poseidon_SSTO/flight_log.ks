...
// Version 12 adds the aerodynamic preflare profile, feed-forward sink command,
// landing sink target, and flare progression needed to diagnose final approach.
global POS_LOG_SCHEMA_VERSION is 12.
