...
// Version 14 adds the terminal preflare pull-up blend so a flight can prove
// whether normal guidance, rather than GPWS, commanded the recovery attitude.
global POS_LOG_SCHEMA_VERSION is 14.
